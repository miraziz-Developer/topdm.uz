...
IP="${SERVER_IP:-$(curl -fsS -4 ifconfig.me 2>/dev/null || hostname -I | awk '{print $1}')}"
DOMAINS=(bozorliii.online www.bozorliii.online api.bozorliii.online crm.bozorliii.online media.bozorliii.online admin.bozorliii.online)
OPTIONAL_DOMAINS=()
